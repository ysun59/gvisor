...
type Communicator interface {
	...
	// AddDonationFD makes fd non-blocking and starts tracking it. The next call
	// to ReleaseFDs will include fd in the order it was added. Communicator
	// takes ownership of fd.
	AddDonationFD(fd int) error
...
func (d *fdTracker) AddDonationFD(fd int) error {
