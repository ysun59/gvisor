...
func (n *nic) addAddress(protocolAddress tcpip.ProtocolAddress, peb PrimaryEndpointBehavior, deprecated bool, preferredLifetime *time.Duration, validLifetime *time.Duration) tcpip.Error {
	...
	addressEndpoint, err := addressableEndpoint.AddAndAcquirePermanentAddress(protocolAddress.AddressWithPrefix, peb, AddressConfigStatic, false /* deprecated */, preferredLifetime, validLifetime)
	if err == nil {
